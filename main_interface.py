...
def musique():
    music = pygame.mixer.Sound("../ressources/sons/maxkomusic-medieval-fantasy.wav")
...
def tableau_image():
    tab_image = [
        "../ressources/images/image_menu/titre.jpeg",
        "../ressources/images/image_menu/play.jpg",
        "../ressources/images/image_menu/settings.jpg",
        "../ressources/images/image_menu/exit.jpg",
        "../ressources/images/image_menu/unmute.xcf",
        "../ressources/images/image_menu/mute.xcf",
        "../ressources/images/image_menu/jouer1.jpg",
        "../ressources/images/image_menu/retour.jpeg",
        "../ressources/images/image_menu/image_test.jpg",
        "../ressources/images/image_menu/verso_carte.jpg",
        "../ressources/images/image_menu/retour.jpeg"
