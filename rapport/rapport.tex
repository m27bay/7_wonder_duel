...
\begin{document}
	...
	% TODO : version JC
	% Nous avons choisi pour l'intervalle des valeurs pour notée nos cartes de 0 a 20, pour choisir les notes des differentes cartes
	% nous nous sommes tous reunis afin de nous concerter pour trouver la note la plus adequate pour la carte. Les cartes sont
	% notées en fonction de l'âge à laquelle elles appartiennent et aussi en fonction de l'importance de la carte. Nous avons
	% donc décidé de prioriser les cartes ressources pour le premier, pour le second âge nous avons décidé de prioriser les ressources
	% rares et nous commençons a mettre en évidence les cartes militaires et scientifiques. Enfin pour le dernier âge se sont
	% les cartes militaires ainsi que les cartes qui rapportent des points de victoires. Nous avons décidé d'un accort commun de
	% mettre l'ensemble des cartes face cachées à une valeur neutre de 10. Suite à ce choix de notation nous avons réalisé
	% la notation des différentes merveilles du jeux, ainsi que des jetons scientifiques.
	...
	Pour des raisons de simplicité nous avons choisit le Python. Une fois % TODO : à suivre
	...
	doit être effectué par le jeu et non dans le module "Carte". % TODO : à suivre
