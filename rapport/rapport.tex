...
\begin{document}
	...
	Nous avons aussi une classe joueur. Le joueur est définit par un nom mais possèdent un liste de cartes dans sa main,
	une liste de meveille, % TODO : a finir
	\begin{lstlisting}
	class Joueur:
		...
		def possede_cartes_couleur(self, couleur: str):
			pass

		def possede_jeton_scientifique(self, nom_jetons_progres: str):
			pass

		def compter_point_victoire(self):
			pass
