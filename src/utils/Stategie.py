...
def minimax(partie, profondeur, coup_bot, nbr_noeuds):
    ...
    if coup_bot:
        ...
        for carte in partie.liste_cartes_prenables():
            ...
            evaluation, _, nbr_noeuds = minimax(
                copie_partie, profondeur - 1, False, nbr_noeuds)
        ...
        for carte in partie.liste_cartes_prenables():
            ...
            evaluation, _, nbr_noeuds = minimax(
                copie_partie, profondeur - 1, True, nbr_noeuds)
...
def alpha_beta(partie, profondeur, alpha, beta, coup_bot, nbr_noeuds):
    ...
    if coup_bot:
        ...
        for carte in partie.liste_cartes_prenables():
            ...
            evaluation, _, nbr_noeuds = alpha_beta(
                copie_partie, profondeur - 1, alpha, beta, False, nbr_noeuds)
        ...
        for carte in partie.liste_cartes_prenables():
            ...
            evaluation, _, nbr_noeuds = alpha_beta(
                copie_partie, profondeur - 1, alpha, beta, True, nbr_noeuds)
...
def alpha_beta_avec_merveille(partie, profondeur, alpha, beta, coup_bot, nbr_noeuds):
    ...
    if coup_bot:
        ...
        for carte in partie.liste_cartes_prenables():
            ...
            evaluation, _, _, nbr_noeuds = alpha_beta_avec_merveille(
                copie_partie, profondeur - 1, alpha, beta, True, nbr_noeuds)
