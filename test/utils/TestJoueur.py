...
class TestJoueur(unittest.TestCase):
    ...
    def test_aucune_ressources_manquantes2(self):
        self.joueur.cartes.append(
            Carte("chantier", ["ressource bois 2"], None, None, "marron", age=1))
    ...
    def test_une_ressources_manquantes(self):
        carte = Carte("atelier",
                      [f"symbole_scientifique {SYMBOLE_SCIENTIFIQUES[3]}", "point_victoire 1"], [
                          "ressource papyrus 1"],
                      None, "vert", age=1)
        self.assertEqual(["ressource papyrus 1"],
                         self.joueur.couts_manquants(carte))
    ...
    def test_une_quantite_ressources_manquantes(self):
        ...
        self.assertEqual(["ressource pierre 1"],
                         self.joueur.couts_manquants(carte))
    ...
    def test_une_quantite_et_une_autre_ressources_manquantes(self):
        ...
        carte = Carte("tribunal", ["point_victoire 5"], ["ressource bois 2", "ressource verre 1"], None,
                      "bleu", age=2)
        self.assertEqual(["ressource bois 1", "ressource verre 1"],
                         self.joueur.couts_manquants(carte))
    ...
    def test_cout_manquant_une_ressource_au_choix(self):
        ...
        carte = Carte("haras", ["attaquer 1"], [
                      "ressource argile 1", "ressource bois 1"], "ecuries", "rouge", age=2)
        liste_couts_manquant = self.joueur.couts_manquants(carte)
        self.assertEqual(["ressource argile 1"], self.joueur.cout_manquant_ressource_au_choix(
            liste_couts_manquant))
    ...
    def test_cout_manquant_deux_ressource_au_choix(self):
        ...
        carte = Carte("haras", ["attaquer 1"], [
                      "ressource argile 1", "ressource bois 1"], "ecuries", "rouge", age=2)
        liste_couts_manquant = self.joueur.couts_manquants(carte)
        self.assertEqual(["ressource bois 1"], self.joueur.cout_manquant_ressource_au_choix(
            liste_couts_manquant))
    ...
    def test_possede_carte_chainage(self):
        ...
        self.assertTrue(self.joueur.possede_carte_chainage(
            Carte("carte2", None, None, "carte", None, None)))
        self.assertFalse(self.joueur.possede_carte_chainage(
            Carte("carte3", None, None, "erreur", None, None)))

    def test_production_type_ressources(self):
        self.joueur.cartes.append(
            Carte("carte", ["ressource bois 1"], None, None, None, None))

        self.assertEqual("carte", self.joueur.production_type_ressources(
            "ressource bois 1").nom)
        self.assertEqual(
            None, self.joueur.production_type_ressources("ressource pierre 1"))
    ...
    def test_possede_cartes_couleur(self):
        ...
        carte2 = Carte("exploitation", ["ressource bois 1"], [
    ...
    def test_liste_merveilles_non_construite(self):
        ...
        self.assertEqual(
            merveilles, self.joueur.liste_merveilles_non_construite())
