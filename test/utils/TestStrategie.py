...
class TestFonctionEvaluationDurantPartie2(unittest.TestCase):
	def setUp(self) -> None:
		...
		self.plateau.cartes_plateau[4][0] = Carte("cavite", ["ressource argile 1"], ["monnaie 1"], None, "marron", age=1)
		...
		self.plateau.cartes_plateau[4][4] = Carte("depot d argile", ["reduc_ressource argile 1"], ["monnaie 3"], None,
			"jaune", age=1)
		self.plateau.cartes_plateau[4][6] = Carte("taverne", ["monnaie 4"], None, None, "jaune", age=1)
		self.plateau.cartes_plateau[4][8] = Carte("tour de garde", ["attaquer 1"], None, None, "rouge", age=1)
		self.plateau.cartes_plateau[4][10] = Carte("gisement", ["ressource pierre 1"], None, None, "marron", age=1)
		...
		self.plateau.cartes_plateau[3][5] = Carte("mine", ["ressource pierre 1"], ["monnaie 1"], None, "marron", age=1)
		self.plateau.cartes_plateau[3][7] = Carte("verrerie", ["ressource verre 1"], ["monnaie 1"], None, "gris", age=1)
		self.plateau.cartes_plateau[3][9] = Carte("bassin argileux", ["ressource argile 1"], None, None, "marron", age=1)
		self.plateau.cartes_plateau[2][2] = Carte("depot de pierre", ["reduc_ressource pierre 1"], ["monnaie 3"], None,
			"jaune", age=1)
		self.plateau.cartes_plateau[2][4] = Carte("presse", ["ressource papyrus 1"], ["monnaie 1"], None, "gris", age=1)
		self.plateau.cartes_plateau[2][6] = Carte("palissade", ["attaquer 1"], ["monnaie 2"], None, "rouge", age=1)
		self.plateau.cartes_plateau[2][8] = Carte("depot de bois", ["reduc_ressource bois 1"], ["monnaie 3"], None, "jaune",
			age=1)
		
		self.plateau.cartes_plateau[1][3] = Carte("ecurie", ["attaquer 1"], ["ressource bois 1"], None, "rouge", age=1)
		self.plateau.cartes_plateau[1][5] = Carte("exploitation", ["ressource bois 1"], ["monnaie 1"], None, "marron", age=1)
		self.plateau.cartes_plateau[1][7] = Carte("autel", ["point_victoire 3"], None, None, "bleu", age=1)
		
		self.plateau.cartes_plateau[0][4] = Carte("apothicaire",
			[f"symbole_scientifique {SYMBOLE_SCIENTIFIQUES[1]}", "point_victoire 1"], ["ressource verre 1"], None,
			"vert", age=1)
		self.plateau.cartes_plateau[0][6] = Carte("bains", ["point_victoire 3"], ["ressource pierre 1"], None, "bleu", age=1)
