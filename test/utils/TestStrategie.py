...
class TestFonctionEvaluation(unittest.TestCase):
	...
	def test_fonction_evaluation_monnaies(self):
		self.plateau.joueur1.monnaie = 7
		self.plateau.joueur2.monnaie = 8
		evaluation = fonction_evaluation(self.plateau)
		self.assertEqual(1, evaluation)
...
class TestFonctionEvaluationDurantPartie(unittest.TestCase):
	...
	def test_fonction_evaluation_joueur_1_carte(self):
		...
		# achat verre => -2 monnaies, eval monnaie = monnaies j2 - monnaies j1 = 7 - 5 = +2
		objectif = - 12 - 2 - 1 + 2
	...
	def test_fonction_evaluation_ordi_1_carte(self):
		...
		# achat bois => -2 monnaies, eval monnaie = monnaies j2 - monnaies j1 = 5 - 7 = -2
		objectif = + 13 + 2 + 2 - 2
		self.assertEqual(objectif, evaluation)
